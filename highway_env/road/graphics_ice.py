...
class LaneGraphics(object):
    ...
    def display(cls, lane: AbstractLane, surface: WorldSurface) -> None:
        ...
        """
        # GageComment check if section is ice and set to display as ice color RGB value (115, 155, 208) maybe in draw ground method below
...
class RoadObjectGraphics:
    ...
    GREEN = (50, 200, 0)
    BLACK = (60, 60, 60)
    ICE = (115, 155, 208) # GageComment Adding ICE color if we decide to make ice objects
