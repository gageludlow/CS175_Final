...
from highway_env.road.lane_ice import LineType, StraightLane, AbstractLane, lane_from_config # GageComment adding ice version of lane.
...
class RoadNetwork(object):
    ...
    def add_lane(self, _from: str, _to: str, lane: AbstractLane) -> None:
        ...
        """
        # GageComment this should add a lane that has a random ice patch somewhere between _from and  _to
        # _from is a value like 0 and _to is a vlue like 100 for the graph in the road network
    ...
    def get_lane(self, index: LaneIndex) -> AbstractLane:
        ...
        # GageComment gets a lane, should not need to be changed
    ...
    def straight_road_network(lanes: int = 4,
        ...
        # GageComment This is the method that created the road by populating RoadNetwork class.
        ...
        for lane in range(lanes):
            ...
            # GageComment This is where lanes are added to the roadnetwork graph via net.add_lane, net is the Roadnetwork
            # class object. then it returns the Roadnetwork, constructed. here we can either leave the code as is and have all lanes 
            # randomly have ice patches in them or we can change the code to to have some normal lanes and some with ice
        return net
...
class Road(object):
    ...
    def __init__(self,
        ...
        """
        # GageComment This is the overall road object used. this road object takes a road network that describes the lanes
